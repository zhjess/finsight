...
kpiRoutes.get('/:year', async (req, res) => {
    ...
    try {
      ...
      // Monthly data
      const monthlyData: { month: string, totalRevenue: number, totalExpenses: number, totalOperational: number, totalNonOperational: number }[] = [];
